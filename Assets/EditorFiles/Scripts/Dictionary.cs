...
public class UDictionary
{
    ...
    public class Drawer : PropertyDrawer
    {
        ...
        private static Defaults _reorderableListDefaults;
        public static Defaults ReorderableListDefaults 
        { 
            get
            {
                if (ReorderableList.defaultBehaviours == null)
                    if (_reorderableListDefaults == null)
                        return _reorderableListDefaults = new Defaults();
                    else
                        return _reorderableListDefaults;
                else
        ...
        {
            ReorderableListDefaults.DrawHeaderBackground(rect);
...
public class UDictionary<TKey, TValue> : UDictionary, IDictionary<TKey, TValue>
{
    ...
    public static implicit operator Dictionary<TKey, TValue>(UDictionary<TKey, TValue> dictionary) => dictionary.Dictionary;
    public static implicit operator UDictionary<TKey, TValue>(Dictionary<TKey, TValue> dictionary) 
    {
        var udictionary = new UDictionary<TKey, TValue>();
        udictionary.cache = dictionary;
        return udictionary;
    }
}